from Task_1B.sllm.sllm_run import Task_1B
from Challenge_1a.extract_from_pdf import Task_1A
# from Task_1A.extract_from_pdf import Task_1A
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith("input.json"):
            ...
            with open(file_path, "r", encoding="utf-8") as f:
                data = json.load(f)
            return data  # or return file_path if you just need path
...
folder_path = '/Users/viswa/Documents/adobe/adobe_hackathon/Adobe-India-Hackathon25/Challenge_1b/Collection 1'
input_data=read_input_json(folder_path)
...
for doc in extracted["documents"]:
    # print(doc)
    parsedText = task1a_handler.parseText(folder_path+"/PDFs/"+doc,True)
